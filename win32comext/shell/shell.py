...
# from F:\Python\Python36\lib\site-packages\win32comext\shell\shell.pyd
# by generator 1.147
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x000002C73A08C5F8>'

__spec__ = None # (!) real value is "ModuleSpec(name='win32comext.shell.shell', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x000002C73A08C5F8>, origin='F:\\\\Python\\\\Python36\\\\lib\\\\site-packages\\\\win32comext\\\\shell\\\\shell.pyd')"
