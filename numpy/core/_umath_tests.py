...
# from F:\Python\Python36\lib\site-packages\numpy\core\_umath_tests.cp36-win_amd64.pyd
# by generator 1.147
# no doc
# no imports
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x000001740A63D0B8>'

__spec__ = None # (!) real value is "ModuleSpec(name='numpy.core._umath_tests', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x000001740A63D0B8>, origin='F:\\\\Python\\\\Python36\\\\lib\\\\site-packages\\\\numpy\\\\core\\\\_umath_tests.cp36-win_amd64.pyd')"
