...
# from F:\Python\Python36\lib\site-packages\numpy\core\_rational_tests.cp36-win_amd64.pyd
# by generator 1.147
# no doc
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x0000016C96F150B8>'

__spec__ = None # (!) real value is "ModuleSpec(name='numpy.core._rational_tests', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x0000016C96F150B8>, origin='F:\\\\Python\\\\Python36\\\\lib\\\\site-packages\\\\numpy\\\\core\\\\_rational_tests.cp36-win_amd64.pyd')"
