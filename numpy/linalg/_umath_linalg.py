...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x0000021068C724E0>'

__spec__ = None # (!) real value is "ModuleSpec(name='numpy.linalg._umath_linalg', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x0000021068C724E0>, origin='F:\\\\Python\\\\Python36\\\\lib\\\\site-packages\\\\numpy\\\\linalg\\\\_umath_linalg.cp36-win_amd64.pyd')"
