...
ucd_3_2_0 = None # (!) real value is '<unicodedata.UCD object at 0x0000018C6C36B1E8>'

ucnhash_CAPI = None # (!) real value is '<capsule object "unicodedata.ucnhash_CAPI" at 0x0000018C6C741B10>'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x0000018C6C73FAC8>'

__spec__ = None # (!) real value is "ModuleSpec(name='unicodedata', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x0000018C6C73FAC8>, origin='C:\\\\BuildAgent\\\\system\\\\.persistent_cache\\\\pythons\\\\python36\\\\DLLs\\\\unicodedata.pyd')"
