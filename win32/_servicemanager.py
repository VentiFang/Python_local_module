# encoding: utf-8
# module win32._servicemanager
# from F:\Python\Python36\lib\site-packages\win32\_servicemanager.cp36-win_amd64.pyd
# by generator 1.147
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x000001A8457925C0>'

__spec__ = None # (!) real value is "ModuleSpec(name='win32._servicemanager', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x000001A8457925C0>, origin='F:\\\\Python\\\\Python36\\\\lib\\\\site-packages\\\\win32\\\\_servicemanager.cp36-win_amd64.pyd')"
