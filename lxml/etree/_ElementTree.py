...
class _ElementTree(object):
    ...
    def write(self, file, encoding=None, method="xml", pretty_print=False, xml_declaration=None, with_tail=True, standalone=None, doctype=None, compression=0, exclusive=False, inclusive_ns_prefixes=None, with_comments=True, strip_text=False): # real signature unknown; restored from __doc__
        """
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000001F681EE38A0>'
