# encoding: utf-8
# module lxml.sax
# from F:\Python\Python36\lib\site-packages\lxml\sax.cp36-win_amd64.pyd
# by generator 1.147
"""
...
class ContentHandler(object):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'xml.sax.handler', '__doc__': 'Interface for receiving logical document content events.\\n\\n    This is the main callback interface in SAX, and the one most\\n    important to applications. The order of events in this interface\\n    mirrors the order of the information in the document.', '__init__': <function ContentHandler.__init__ at 0x00000177C2FAAA60>, 'setDocumentLocator': <function ContentHandler.setDocumentLocator at 0x00000177C2FAAAE8>, 'startDocument': <function ContentHandler.startDocument at 0x00000177C2FAAB70>, 'endDocument': <function ContentHandler.endDocument at 0x00000177C2FAABF8>, 'startPrefixMapping': <function ContentHandler.startPrefixMapping at 0x00000177C2FAAC80>, 'endPrefixMapping': <function ContentHandler.endPrefixMapping at 0x00000177C2FAAD08>, 'startElement': <function ContentHandler.startElement at 0x00000177C2FAAD90>, 'endElement': <function ContentHandler.endElement at 0x00000177C2FAAE18>, 'startElementNS': <function ContentHandler.startElementNS at 0x00000177C2FAAEA0>, 'endElementNS': <function ContentHandler.endElementNS at 0x00000177C2FAAF28>, 'characters': <function ContentHandler.characters at 0x00000177C2FC8048>, 'ignorableWhitespace': <function ContentHandler.ignorableWhitespace at 0x00000177C2FC80D0>, 'processingInstruction': <function ContentHandler.processingInstruction at 0x00000177C2FC8158>, 'skippedEntity': <function ContentHandler.skippedEntity at 0x00000177C2FC81E0>, '__dict__': <attribute '__dict__' of 'ContentHandler' objects>, '__weakref__': <attribute '__weakref__' of 'ContentHandler' objects>})"
...
class ElementTreeProducer(object):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x00000177C33B5BD0>'
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x00000177C2FA45C0>'

__pyx_capi__ = {
    '_getNsTag': None, # (!) real value is '<capsule object "PyObject *(PyObject *)" at 0x00000177C33B5BA0>'
}

__spec__ = None # (!) real value is "ModuleSpec(name='lxml.sax', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x00000177C2FA45C0>, origin='F:\\\\Python\\\\Python36\\\\lib\\\\site-packages\\\\lxml\\\\sax.cp36-win_amd64.pyd')"
