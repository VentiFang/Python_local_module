...
# from F:\Python\Python36\lib\site-packages\pandas\_libs\json.cp36-win_amd64.pyd
# by generator 1.147
# no doc
# no imports
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x000002070106EF98>'

__spec__ = None # (!) real value is "ModuleSpec(name='pandas._libs.json', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x000002070106EF98>, origin='F:\\\\Python\\\\Python36\\\\lib\\\\site-packages\\\\pandas\\\\_libs\\\\json.cp36-win_amd64.pyd')"
