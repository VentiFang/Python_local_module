...
# from F:\Python\Python36\lib\site-packages\pandas\_libs\internals.cp36-win_amd64.pyd
# by generator 1.147
# no doc
...
class BlockPlacement(object):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000001A77CDE9C00>'


# variables with complex values

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x000001A77CE1D630>'

__spec__ = None # (!) real value is "ModuleSpec(name='pandas._libs.internals', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x000001A77CE1D630>, origin='F:\\\\Python\\\\Python36\\\\lib\\\\site-packages\\\\pandas\\\\_libs\\\\internals.cp36-win_amd64.pyd')"
