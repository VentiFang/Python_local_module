...
# from F:\Python\Python36\lib\site-packages\pandas\_libs\groupby.cp36-win_amd64.pyd
# by generator 1.147
# no doc
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x000001C74CBEB630>'

__spec__ = None # (!) real value is "ModuleSpec(name='pandas._libs.groupby', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x000001C74CBEB630>, origin='F:\\\\Python\\\\Python36\\\\lib\\\\site-packages\\\\pandas\\\\_libs\\\\groupby.cp36-win_amd64.pyd')"
