...
# from F:\Python\Python36\lib\site-packages\pandas\_libs\tslibs\frequencies.cp36-win_amd64.pyd
# by generator 1.147
# no doc
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x0000020D5E85D518>'

__pyx_capi__ = {
    'get_base_alias': None, # (!) real value is '<capsule object "PyObject *(PyObject *, int __pyx_skip_dispatch)" at 0x0000020D5E851870>'
    'get_freq': None, # (!) real value is '<capsule object "PyObject *(PyObject *, int __pyx_skip_dispatch)" at 0x0000020D5E851840>'
    'get_freq_code': None, # (!) real value is '<capsule object "PyObject *(PyObject *, int __pyx_skip_dispatch)" at 0x0000020D5E851810>'
    'get_freq_str': None, # (!) real value is '<capsule object "PyObject *(PyObject *, int __pyx_skip_dispatch, struct __pyx_opt_args_6pandas_5_libs_6tslibs_11frequencies_get_freq_str *__pyx_optional_args)" at 0x0000020D5E8518D0>'
    'get_rule_month': None, # (!) real value is '<capsule object "PyObject *(PyObject *, int __pyx_skip_dispatch, struct __pyx_opt_args_6pandas_5_libs_6tslibs_11frequencies_get_rule_month *__pyx_optional_args)" at 0x0000020D5E8517E0>'
    'get_to_timestamp_base': None, # (!) real value is '<capsule object "int (int, int __pyx_skip_dispatch)" at 0x0000020D5E8518A0>'
}

__spec__ = None # (!) real value is "ModuleSpec(name='pandas._libs.tslibs.frequencies', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x0000020D5E85D518>, origin='F:\\\\Python\\\\Python36\\\\lib\\\\site-packages\\\\pandas\\\\_libs\\\\tslibs\\\\frequencies.cp36-win_amd64.pyd')"
