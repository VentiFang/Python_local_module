...
# from F:\Python\Python36\lib\site-packages\pandas\_libs\tslibs\timedeltas.cp36-win_amd64.pyd
# by generator 1.147
# no doc

# imports
import builtins as __builtins__ # <module 'builtins' (built-in)>
import collections as collections # F:\Python\Python36\lib\collections\__init__.py
import textwrap as textwrap # F:\Python\Python36\lib\textwrap.py
...
class _Timedelta(__datetime.timedelta):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x00000233A3D1C540>'
...
class Timedelta(_Timedelta):
    ...
    __dict__ = None # (!) real value is 'mappingproxy({\'__module__\': \'pandas._libs.tslibs.timedeltas\', \'__doc__\': "\\n    Represents a duration, the difference between two dates or times.\\n\\n    Timedelta is the pandas equivalent of python\'s ``datetime.timedelta``\\n    and is interchangeable with it in most cases.\\n\\n    Parameters\\n    ----------\\n    value : Timedelta, timedelta, np.timedelta64, string, or integer\\n    unit : str, optional\\n        Denote the unit of the input, if input is an integer. Default \'ns\'.\\n        Possible values:\\n        {\'Y\', \'M\', \'W\', \'D\', \'days\', \'day\', \'hours\', hour\', \'hr\', \'h\',\\n        \'m\', \'minute\', \'min\', \'minutes\', \'T\', \'S\', \'seconds\', \'sec\', \'second\',\\n        \'ms\', \'milliseconds\', \'millisecond\', \'milli\', \'millis\', \'L\',\\n        \'us\', \'microseconds\', \'microsecond\', \'micro\', \'micros\', \'U\',\\n        \'ns\', \'nanoseconds\', \'nano\', \'nanos\', \'nanosecond\', \'N\'}\\n    days, seconds, microseconds,\\n    milliseconds, minutes, hours, weeks : numeric, optional\\n        Values for construction in compat with datetime.timedelta.\\n        np ints and floats will be coerced to python ints and floats.\\n\\n    Notes\\n    -----\\n    The ``.value`` attribute is always in ns.\\n\\n    ", \'__new__\': <cyfunction Timedelta.__new__ at 0x00000233A3D3E8E8>, \'__setstate__\': <cyfunction Timedelta.__setstate__ at 0x00000233A3D3E9A0>, \'__reduce__\': <cyfunction Timedelta.__reduce__ at 0x00000233A3D3EA58>, \'_round\': <cyfunction Timedelta._round at 0x00000233A3D3EB10>, \'round\': <cyfunction Timedelta.round at 0x00000233A3D3EBC8>, \'floor\': <cyfunction Timedelta.floor at 0x00000233A3D3EC80>, \'ceil\': <cyfunction Timedelta.ceil at 0x00000233A3D3ED38>, \'__inv__\': <cyfunction _op_unary_method.<locals>.f at 0x00000233A3D3EEA8>, \'__neg__\': <cyfunction _op_unary_method.<locals>.f at 0x00000233A3D3F048>, \'__pos__\': <cyfunction _op_unary_method.<locals>.f at 0x00000233A3D3F1B8>, \'__abs__\': <cyfunction _op_unary_method.<locals>.f at 0x00000233A3D3F328>, \'__add__\': <cyfunction _binary_op_method_timedeltalike.<locals>.f at 0x00000233A3D3F498>, \'__radd__\': <cyfunction _binary_op_method_timedeltalike.<locals>.f at 0x00000233A3D3F608>, \'__sub__\': <cyfunction _binary_op_method_timedeltalike.<locals>.f at 0x00000233A3D3F778>, \'__rsub__\': <cyfunction _binary_op_method_timedeltalike.<locals>.f at 0x00000233A3D3F8E8>, \'__mul__\': <cyfunction Timedelta.__mul__ at 0x00000233A3D3F9A0>, \'__rmul__\': <cyfunction Timedelta.__mul__ at 0x00000233A3D3F9A0>, \'__truediv__\': <cyfunction Timedelta.__truediv__ at 0x00000233A3D3FA58>, \'__rtruediv__\': <cyfunction Timedelta.__rtruediv__ at 0x00000233A3D3FB10>, \'__floordiv__\': <cyfunction Timedelta.__floordiv__ at 0x00000233A3D3FBC8>, \'__rfloordiv__\': <cyfunction Timedelta.__rfloordiv__ at 0x00000233A3D3FC80>, \'__mod__\': <cyfunction Timedelta.__mod__ at 0x00000233A3D3FD38>, \'__rmod__\': <cyfunction Timedelta.__rmod__ at 0x00000233A3D3FDF0>, \'__divmod__\': <cyfunction Timedelta.__divmod__ at 0x00000233A3D3FEA8>, \'__rdivmod__\': <cyfunction Timedelta.__rdivmod__ at 0x00000233A3D3FF60>, \'__dict__\': <attribute \'__dict__\' of \'Timedelta\' objects>, \'__weakref__\': <attribute \'__weakref__\' of \'Timedelta\' objects>, \'min\': Timedelta(\'-106752 days +00:12:43.145224\'), \'max\': Timedelta(\'106751 days 23:47:16.854775\')})'
...
_no_input = None # (!) real value is '<object object at 0x000002339263BA40>'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x00000233A3D19128>'

__pyx_capi__ = {
    'cast_from_unit': None, # (!) real value is '<capsule object "__pyx_t_5numpy_int64_t (PyObject *, PyObject *)" at 0x00000233A3D1C4B0>'
    'convert_to_timedelta64': None, # (!) real value is '<capsule object "PyObject *(PyObject *, PyObject *)" at 0x00000233A3D1C510>'
    'delta_to_nanoseconds': None, # (!) real value is '<capsule object "__pyx_t_5numpy_int64_t (PyObject *, int __pyx_skip_dispatch)" at 0x00000233A3D1C4E0>'
}

__spec__ = None # (!) real value is "ModuleSpec(name='pandas._libs.tslibs.timedeltas', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x00000233A3D19128>, origin='F:\\\\Python\\\\Python36\\\\lib\\\\site-packages\\\\pandas\\\\_libs\\\\tslibs\\\\timedeltas.cp36-win_amd64.pyd')"
