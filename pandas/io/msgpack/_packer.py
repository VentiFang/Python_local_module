...
# from F:\Python\Python36\lib\site-packages\pandas\io\msgpack\_packer.cp36-win_amd64.pyd
# by generator 1.147
# no doc
...
class ExtType(__pandas_io_msgpack.ExtType):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'pandas.io.msgpack', '__doc__': 'ExtType represents ext type in msgpack.', '__new__': <staticmethod object at 0x000001CAC669B5F8>, '__dict__': <attribute '__dict__' of 'ExtType' objects>})"
...
class Packer(object):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000001CAC666ECF0>'
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x000001CAC669BEF0>'

__spec__ = None # (!) real value is "ModuleSpec(name='pandas.io.msgpack._packer', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x000001CAC669BEF0>, origin='F:\\\\Python\\\\Python36\\\\lib\\\\site-packages\\\\pandas\\\\io\\\\msgpack\\\\_packer.cp36-win_amd64.pyd')"
