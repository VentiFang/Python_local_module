...
# from F:\Python\Python36\lib\site-packages\pandas\util\_move.cp36-win_amd64.pyd
# by generator 1.147
# no doc
# no imports
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x00000181786AB198>'

__spec__ = None # (!) real value is "ModuleSpec(name='pandas.util._move', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x00000181786AB198>, origin='F:\\\\Python\\\\Python36\\\\lib\\\\site-packages\\\\pandas\\\\util\\\\_move.cp36-win_amd64.pyd')"
