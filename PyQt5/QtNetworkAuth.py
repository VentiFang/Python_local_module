...
# from F:\Python\Python36\lib\site-packages\PyQt5\QtNetworkAuth.pyd
# by generator 1.147
# no doc
...
class QAbstractOAuth(__PyQt5_QtCore.QObject):
    ...
    def prepareRequest(self, QNetworkRequest, Union, QByteArray=None, bytes=None, bytearray=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ prepareRequest(self, QNetworkRequest, Union[QByteArray, bytes, bytearray], body: Union[QByteArray, bytes, bytearray] = QByteArray()) """
        pass
...
class QOAuth1(QAbstractOAuth):
    ...
    def setup(self, QNetworkRequest, Dict, p_str=None, Any=None, *args, **kwargs): # real signature unknown; restored from __doc__ with multiple overloads
        """
        setup(self, QNetworkRequest, Dict[str, Any], QNetworkAccessManager.Operation)
        setup(self, QNetworkRequest, Dict[str, Any], Union[QByteArray, bytes, bytearray])
        """
        pass
...
class QOAuth1Signature(__sip.simplewrapper):
    ...
    def customMethodString(self): # real signature unknown; restored from __doc__
        """ customMethodString(self) -> QByteArray """
        pass
    ...
    def setCustomMethodString(self, Union, QByteArray=None, bytes=None, bytearray=None): # real signature unknown; restored from __doc__
        """ setCustomMethodString(self, Union[QByteArray, bytes, bytearray]) """
        pass
