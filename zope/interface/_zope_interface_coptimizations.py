...
# from F:\Python\Python36\lib\site-packages\zope\interface\_zope_interface_coptimizations.cp36-win_amd64.pyd
# by generator 1.147
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x0000025030CFF4A8>'

__spec__ = None # (!) real value is "ModuleSpec(name='zope.interface._zope_interface_coptimizations', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x0000025030CFF4A8>, origin='F:\\\\Python\\\\Python36\\\\lib\\\\site-packages\\\\zope\\\\interface\\\\_zope_interface_coptimizations.cp36-win_amd64.pyd')"
